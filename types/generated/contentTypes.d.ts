...
export interface ApiNoticeTemplateNoticeTemplate
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::notice-template.notice-template'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    template_content: Schema.Attribute.Text;
    template_title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTestTest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Content_rich: Schema.Attribute.Blocks;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::test.test'> &
      Schema.Attribute.Private;
    notice_template: Schema.Attribute.Relation<
      'oneToOne',
      'api::notice-template.notice-template'
    >;
    publishedAt: Schema.Attribute.DateTime;
    Push_schedule: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_template: Schema.Attribute.Boolean;
...
export interface ApiUserTypeUserType extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    post: Schema.Attribute.Relation<'manyToOne', 'api::test.test'>;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::notice-template.notice-template': ApiNoticeTemplateNoticeTemplate;
